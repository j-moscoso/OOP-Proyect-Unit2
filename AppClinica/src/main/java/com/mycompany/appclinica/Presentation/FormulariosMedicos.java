 ...
 * Permite introducir o modificar datos como cédula, nombre, apellido,
 * teléfono y especialidad.
 * Utiliza el servicio de médicos para guardar o actualizar la información.
 * 
...
public class FormulariosMedicos extends javax.swing.JInternalFrame {
    ...
    private Medico medico; // Médico a editar o null para nuevo médico
    /**
     * Constructor que inicializa el formulario con servicios y médico.
     * Si el médico es distinto de null, rellena los campos para edición
     * y bloquea la edición del campo cédula.
     * 
     * @param medicoService Servicio para gestión de médicos
     * @param medico Médico a editar o null para crear nuevo
     */
    ...
    /**
    * Carga el comboBox especialidades con todas las especialidades posibles.
    * Limpia previamente el combo antes de agregar las opciones.
    */
    ...
    // Métodos vacíos generados para eventos en campos de texto
    ...
    /**
     * Acción del botón limpiar para borrar los campos y preparar formulario para nuevo ingreso.
     * En modo edición, la cédula queda bloqueada; solo se limpia si es nuevo médico.
     * 
     * @param evt evento de acción
     */
     ...
     * Crea un nuevo médico o actualiza la información si el médico ya existe.
     * Utiliza el servicio de médicos para persistir los datos.
     ...
     * Puede implementarse si se requiere.
     *
     * @param evt evento de acción
     */
